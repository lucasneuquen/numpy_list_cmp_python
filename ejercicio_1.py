...
if __name__ == '__main__':
    ...
    valor=int(input('Ingrese un número que desee elevar al cuadrado: '))
    potencia_2 = lambda x:x**2
    pot_3 = potencia_2(valor)
    print('El número ingresado elevado al cuadrado es: ', pot_3)
    #
    ...
    print('Los cuadrados de los números de la lista son : ', numeros_potencia)
    print("terminamos")